...
class Process_Viewer_Memory extends ClearOS_Controller
{
    /**
     * Default controller.
     *
    ...
    function index()
    {
        ...
        $this->page->view_form('process_viewer/memory', $data, lang('process_viewer_process_memory_usage'));
    }
    ...
    function get_data()
    {
        ...
        try {
            $data = $this->process_manager->get_memory_summary();
        } catch (Exception $e) {
